...
const { createNotification } = require('./notification.controller'); // 추가
const { Comment } = require('../models/comment.model'); // 신규 추가: 댓글 모델 import
const { SearchLog } = require('../models/searchLog.model'); // 신규 추가: 검색어 모델 import
