...
const { deleteImage } = require('../middlewares/upload.middleware'); // deleteImage 함수 추가
const { CHAT_CATEGORY } = require('../constants/constants'); // 상수 불러오기
const { createNotification } = require('./notification.controller'); // 알림 함수 추가
